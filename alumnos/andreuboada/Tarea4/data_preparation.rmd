...
ds.path <- "/Users/andreuboada/Dropbox/ESTADISTICA/itam-dm/alumnos/andreuboada/Tarea3/pruebacup98lrn.txt" # Puede ser un URL o una dirección en el directorio

ds.name <- "pruebacup98lrn" # Nombre de nuestro conjunto de datos, e.g. algas, german
...
FCB.filtering <- function(datos, yname, delta = 0.9){
  ...
  return(vars.quitan[complete.cases(vars.quitan)])
}

vars.a.ignorar.3<-FCB.filtering(ds,"target.d",0.1)
...
# 
# Call:
#  randomForest(formula = target.d ~ ., data = ds[, !(colnames(ds) %in%      variables.a.ignorar)], na.action = "na.delete") 
#                Type of random forest: regression
#                      Number of trees: 500
# No. of variables tried at each split: 128
# 
#           Mean of squared residuals: 28.23429
#                     % Var explained: -19.6
```

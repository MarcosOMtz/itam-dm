...
source("/home/jared/Proyectos/itam-dm/alumnos/jared275/german/0-load.r")
...
german.data<-chang_code()

names(german.data)<-tolower(gsub(" ",".",names(german.data)))
names(german.data)<-gsub("/",".",names(german.data))
